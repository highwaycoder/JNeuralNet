...
class MapSimulation {
	...
	MapSimulation(int x, int y, int numOfSeekables, EnumSet<ItemType> seekables) {
		xSize = x;
		ySize = y;
	...
	MapSimulation(int numOfSeekables, EnumSet<ItemType> seekables) {
		this(DEFAULT_XSIZE,DEFAULT_YSIZE,numOfSeekables,seekables);
	}
	
	MapSimulation(EnumSet<ItemType> seekables) {
		this(DEFAULT_NUMOFSEEKABLES,seekables);
	}
	
	void spawnSeekable(EnumSet<ItemType> seekables) {
	...
	void setItemAt(int[] coords,EnumSet<ItemType> t) {
	...
	short getClosestSeekable(EnumSet<ItemType> seeking, int[] coords, double direction) {
